...
public class Searcher extends JFrame {
	...
	public Searcher() {
		...
		lblEnterQuery.setFont(new Font("Arial", Font.PLAIN, 15));
		lblEnterQuery.setBounds(12, 14, 97, 27);
		contentPane.add(lblEnterQuery);
		
		QueryField = new JTextField();
		QueryField.setFont(new Font("Arial", Font.PLAIN, 15));
		...
		PreviousButton.setFont(new Font("Arial", Font.PLAIN, 15));
		PreviousButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			    ...
			    //Print
			    ResultsArea.setText(ResultsArea.getText() + "Quit Button" + "\n");
			}
		});
		...
		ChooseButton.setFont(new Font("Arial", Font.PLAIN, 15));
	  ...
	  public static void doPagingSearch(BufferedReader in, Query query, boolean raw, boolean interactive) throws IOException {
	    results = searcher.search(query, 50000 * hitsPerPage);
